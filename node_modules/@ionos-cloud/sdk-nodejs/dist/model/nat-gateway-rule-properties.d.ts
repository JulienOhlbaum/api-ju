 ...
 */
import { NatGatewayRuleProtocol } from './nat-gateway-rule-protocol';
import { NatGatewayRuleType } from './nat-gateway-rule-type';
import { TargetPortRange } from './target-port-range';
/**
 *
 * @export
 * @interface NatGatewayRuleProperties
 */
export interface NatGatewayRuleProperties {
    /**
