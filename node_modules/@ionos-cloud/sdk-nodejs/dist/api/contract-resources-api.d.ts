 ...
 * @export
 */
export declare const ContractResourcesApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    contractsGet: (pretty?: boolean, depth?: number, xContractNumber?: number, orderBy?: string, maxResults?: number, filters?: Map<string, string>, options?: any) => Promise<RequestArgs>;
};
/**
 * ContractResourcesApi - functional programming interface
 * @export
 */
export declare const ContractResourcesApiFp: (configuration?: Configuration) => {
    /**
     * Retrieve the properties of the user\'s contract. In this version, the resource became a collection.
     * @summary Retrieve contracts
     * @param {boolean} [pretty] Controls whether the response is pretty-printed (with indentations and new lines).
     ...
     * @throws {RequiredError}
     */
    contractsGet(pretty?: boolean, depth?: number, xContractNumber?: number, orderBy?: string, maxResults?: number, filters?: Map<string, string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Contracts>>;
};
/**
 * ContractResourcesApi - factory interface
 * @export
 */
export declare const ContractResourcesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Retrieve the properties of the user\'s contract. In this version, the resource became a collection.
     * @summary Retrieve contracts
     * @param {boolean} [pretty] Controls whether the response is pretty-printed (with indentations and new lines).
 ...
 * @extends {BaseAPI}
 */
export declare class ContractResourcesApi extends BaseAPI {
    /**
     * Retrieve the properties of the user\'s contract. In this version, the resource became a collection.
     * @summary Retrieve contracts
     ...
     */
    contractsGet(requestParameters?: ContractResourcesApiContractsGetRequest, options?: any): Promise<import("axios").AxiosResponse<Contracts>>;
}
