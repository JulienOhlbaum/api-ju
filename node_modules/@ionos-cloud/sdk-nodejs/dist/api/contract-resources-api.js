...
exports.ContractResourcesApi = exports.ContractResourcesApiFactory = exports.ContractResourcesApiFp = exports.ContractResourcesApiAxiosParamCreator = void 0;
 ...
 * @export
 */
exports.ContractResourcesApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         ...
         */
        contractsGet: function (pretty, depth, xContractNumber, orderBy, maxResults, filters, options) {
 ...
 * @export
 */
exports.ContractResourcesApiFp = function (configuration) {
    return {
        /**
         * Retrieve the properties of the user\'s contract. In this version, the resource became a collection.
         * @summary Retrieve contracts
        ...
        contractsGet: function (pretty, depth, xContractNumber, orderBy, maxResults, filters, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.ContractResourcesApiAxiosParamCreator(configuration).contractsGet(pretty, depth, xContractNumber, orderBy, maxResults, filters, options)];
                        case 1:
                            axiosArgs = _a.sent();
 ...
 * @export
 */
exports.ContractResourcesApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * Retrieve the properties of the user\'s contract. In this version, the resource became a collection.
         * @summary Retrieve contracts
         ...
         * @throws {RequiredError}
         */
        contractsGet: function (pretty, depth, xContractNumber, options) {
            return exports.ContractResourcesApiFp(configuration).contractsGet(pretty, depth, xContractNumber, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
 ...
 * @extends {BaseAPI}
 */
var ContractResourcesApi = /** @class */ (function (_super) {
    __extends(ContractResourcesApi, _super);
    function ContractResourcesApi() {
     ...
     */
    ContractResourcesApi.prototype.contractsGet = function (requestParameters, options) {
        var _this = this;
        if (requestParameters === void 0) { requestParameters = {}; }
        return exports.ContractResourcesApiFp(this.configuration).contractsGet(requestParameters.pretty, requestParameters.depth, requestParameters.xContractNumber, requestParameters.orderBy, requestParameters.maxResults, requestParameters.filters, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return ContractResourcesApi;
}(base_1.BaseAPI));
exports.ContractResourcesApi = ContractResourcesApi;
