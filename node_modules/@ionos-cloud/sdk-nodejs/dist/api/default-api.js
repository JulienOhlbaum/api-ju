...
exports.DefaultApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        apiInfoGet: function (pretty, depth, xContractNumber, orderBy, maxResults, filters, options) {
    ...
    return {
        ...
        apiInfoGet: function (pretty, depth, xContractNumber, orderBy, maxResults, filters, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.DefaultApiAxiosParamCreator(configuration).apiInfoGet(pretty, depth, xContractNumber, orderBy, maxResults, filters, options)];
                        case 1:
                            axiosArgs = _a.sent();
...
exports.DefaultApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiInfoGet: function (pretty, depth, xContractNumber, options) {
            return exports.DefaultApiFp(configuration).apiInfoGet(pretty, depth, xContractNumber, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var DefaultApi = /** @class */ (function (_super) {
     ...
     * @memberof DefaultApi
     */
    DefaultApi.prototype.apiInfoGet = function (requestParameters, options) {
        var _this = this;
        if (requestParameters === void 0) { requestParameters = {}; }
        return exports.DefaultApiFp(this.configuration).apiInfoGet(requestParameters.pretty, requestParameters.depth, requestParameters.xContractNumber, requestParameters.orderBy, requestParameters.maxResults, requestParameters.filters, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return DefaultApi;
}(base_1.BaseAPI));
