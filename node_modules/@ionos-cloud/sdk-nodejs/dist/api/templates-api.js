...
exports.TemplatesApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        templatesFindById: function (templateId, depth, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            if (templateId === null || templateId === undefined) {
                                throw new base_1.RequiredError('templateId', 'Required parameter templateId was null or undefined when calling templatesFindById.');
                            }
                            localVarPath = "/templates/{templateId}"
         ...
         * @throws {RequiredError}
         */
        templatesGet: function (depth, orderBy, maxResults, filters, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, localVarApiKeyValue, _a, queryParameters, key, key, headersFromBaseOptions;
                return __generator(this, function (_b) {
    ...
    return {
        ...
        templatesFindById: function (templateId, depth, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.TemplatesApiAxiosParamCreator(configuration).templatesFindById(templateId, depth, options)];
                        case 1:
                            axiosArgs = _a.sent();
        ...
        templatesGet: function (depth, orderBy, maxResults, filters, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.TemplatesApiAxiosParamCreator(configuration).templatesGet(depth, orderBy, maxResults, filters, options)];
                        case 1:
                            axiosArgs = _a.sent();
                            return [2 /*return*/, base_1.runRequest(axiosArgs, configuration)];
                    }
...
exports.TemplatesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        templatesFindById: function (templateId, depth, options) {
            return exports.TemplatesApiFp(configuration).templatesFindById(templateId, depth, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * List all of the available Cubes Templates.  This operation is only supported for the Cubes.
         * @summary List Cubes Templates
         ...
         * @throws {RequiredError}
         */
        templatesGet: function (depth, options) {
            return exports.TemplatesApiFp(configuration).templatesGet(depth, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var TemplatesApi = /** @class */ (function (_super) {
     ...
     */
    TemplatesApi.prototype.templatesFindById = function (requestParameters, options) {
        var _this = this;
        return exports.TemplatesApiFp(this.configuration).templatesFindById(requestParameters.templateId, requestParameters.depth, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * List all of the available Cubes Templates.  This operation is only supported for the Cubes.
     * @summary List Cubes Templates
     ...
     * @memberof TemplatesApi
     */
    TemplatesApi.prototype.templatesGet = function (requestParameters, options) {
        var _this = this;
        if (requestParameters === void 0) { requestParameters = {}; }
        return exports.TemplatesApiFp(this.configuration).templatesGet(requestParameters.depth, requestParameters.orderBy, requestParameters.maxResults, requestParameters.filters, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return TemplatesApi;
}(base_1.BaseAPI));
